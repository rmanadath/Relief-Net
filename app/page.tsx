      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Post Requests</h3>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Connect Volunteers</h3>
            <p className="text-gray-600">
              Connect with volunteers who can provide the help you need in your area.
            </p>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-12 mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-2xl font-bold text-indigo-400 mb-4">Relief-Net</h3>
